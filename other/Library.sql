...
--
-- Решение. Предлагаются 2 критерия: 1) Чтение книги больше разрешенного, в данном случае - это 14 дней. 2) Взятие очередной книги раньше
-- сдачи предыдущей. По каждому читателю вычисляется количество строк соответствующих первому ИЛИ второму критерию. Если какая-то строка
-- подпадает под оба условия, в штрафной показатель она зачитывается дважды. Далее читатели ранжируются по количеству таких штрафных очков
