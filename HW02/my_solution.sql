------------------------------------------------------------------------------------
-- #1 ¬се товары, в которых в название есть пометка urgent или
-- название начинаетс€ с Animal 
------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------
--#2 ѕоставщиков, у которых не было сделано ни одного заказа, JOIN
------------------------------------------------------------------------------------
USE WideWorldImporters;
...
------------------------------------------------------------------------------------
-- #3. ѕродажи с названием мес€ца, в котором была продажа, номером квартала, 
-- к которому относитс€ продажа, включите также к какой трети года относитс€ дата - кажда€ 
-- треть по 4 мес€ца, дата забора заказа должна быть задана, с ценой товара более 100$ либо 
-- количество единиц товара более 20. ƒобавьте вариант этого запроса с постраничной выборкой 
-- пропустив первую 1000 и отобразив следующие 100 записей. 
-- —ортировка должна быть по номеру квартала, трети года, дате продажи. 
------------------------------------------------------------------------------------
...
---------------------------------------------------------
-- 4. «аказы поставщикам, которые были исполнены за 2014й год 
-- с доставкой Road Freight или Post, добавьте название поставщика, 
-- им€ контактного лица принимавшего заказ
---------------------------------------------------------
